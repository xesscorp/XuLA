XuLA-200 Board Design Projects
    Each of these directories contains a complete Xilinx ISE WebPACK 13
    design project.

    * blinker
        A simple LED blinker design from chapter 4 of the book "FPGAs!? Now
        What?".

    * counter
        A simple 26-bit counter that is driven by a 100 MHz clock and whose
        bits are output through the prototyping header. This is a good
    ...
    * fast_blinker
        The LED blinker design sped-up by using a DCM from chapter 5 of the
        book "FPGAs!? Now What?".
    ...
    * hostio_test
        This design is used to test the ability of the HostIo modules to
        pass data back-and-forth between the FPGA and the host PC.
    ...
    * vga_bram
        This is a character-based VGA module. *It uses a third-party VGA
        controller and not the VGA module in the XuLA_lib directory.*
